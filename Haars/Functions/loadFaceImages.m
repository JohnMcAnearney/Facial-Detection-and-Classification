function imageAndLabels = loadFaceImages(filename,sampling)
addpath  csc3067-2021-g21\images\face
addpath  csc3067-2021-g21\images\non-face
...
imageAndLabels.labels = labels;
imageAndLabels.images = images;
fclose(fp);
