clear all
close all
%% Implementation test of LDA; was not successful
%% PreProcessing
timing = [];
tic
...
% Apply LDA
[eigenVectors, eigenValues, meanX, Xlda] = LDA(edgeMtx.labels,[],edgeMtx.images);
...
modelSVM = SVMtraining(Xlda, edgeMtx.labels, 2);
toc
trainEnd = toc;
